...
const translations = {
  en: {
    ...
    highlightText:
      "Seasoned ground beef & lamb blended with saffron and spices, grilled on open flame to smoky perfection.",
    ...
    aboutCard2Text: "Traditional Persian grilling techniques for authentic smoky flavor.",
    aboutCard3Title: "Catering & Events",
    aboutCard3Text: "Custom catering packages for corporate and private events.",
    menuTitle: "Our Persian & Iraqi Menu",
    menuIntro:
      "A rich selection of Persian and Iraqi specialties. Ask our team about daily specials, lunch deals, and family platters.",
    menuAppTitle: "Appetizers & Salads",
    menuApp1: "Hummus with warm pita",
    menuApp2: "Mast-o-Khiar (yogurt & cucumber)",
    menuApp3: "Fattoush & Shirazi salad",
    menuApp4: "Dolmeh (stuffed grape leaves)",
    menuGrillTitle: "The Grills",
    menuGrill1: "Kebab Koobideh (ground lamb & beef)",
    menuGrill2: "Joojeh Kabab (saffron grilled chicken)",
    menuGrill3: "Barg (filet mignon skewers)",
    menuGrill4: "Mixed grill platter",
    menuDishTitle: "Dishes of the Day",
    menuDish1: "Baghali Polo ba Mahiche (lamb shank & dill rice)",
    menuDish2: "Ghormeh Sabzi (herb & kidney bean stew)",
    menuDish3: "Fesenjan (pomegranate walnut chicken)",
    menuDish4: "Ask our team for today's special",
    menuShawarmaTitle: "Shawarma",
    menuShawarma1: "Chicken shawarma plate",
    menuShawarma2: "Beef shawarma plate",
    menuShawarma3: "Shish Taouk plate",
    menuShawarma4: "Kafta Kabab plate",
    menuSandTitle: "Sandwiches & Trios",
    menuSand1: "Shawarma sandwich (chicken or beef)",
    menuSand2: "Shish Taouk sandwich",
    menuSand3: "Kafta sandwich",
    menuSand4: "Trio combo (sandwich + fries + drink)",
    menuSeafoodTitle: "Seafood",
    menuSeafood1: "Grilled salmon fillet",
  ...
  fr: {
    ...
    highlightText:
      "Bœuf et agneau hachés assaisonnés au safran et aux épices, grillés à la flamme vive jusqu'à la perfection fumée.",
    ...
    aboutCard2Text: "Techniques de grillade persanes traditionnelles pour une saveur fumée authentique.",
    aboutCard3Title: "Traiteur & Événements",
    aboutCard3Text: "Forfaits traiteur personnalisés pour événements d'entreprise et privés.",
    menuTitle: "Notre Menu Persan & Irakien",
    menuIntro:
      "Une riche sélection de spécialités persanes et irakiennes. Demandez à notre équipe les spéciaux du jour, les offres du lunch et les plateaux familiaux.",
    menuAppTitle: "Entrées & Salades",
    menuApp1: "Houmous avec pita chaud",
    menuApp2: "Mast-o-Khiar (yaourt et concombre)",
    menuApp3: "Salade Fattoush & Shirazi",
    menuApp4: "Dolmeh (feuilles de vigne farcies)",
    menuGrillTitle: "Les Grillades",
    menuGrill1: "Kebab Koobideh (agneau et bœuf hachés)",
    menuGrill2: "Joojeh Kabab (poulet grillé au safran)",
    menuGrill3: "Barg (brochettes de filet mignon)",
    menuGrill4: "Plateau de grillades mixtes",
    menuDishTitle: "Plats du Jour",
    menuDish1: "Baghali Polo ba Mahiche (jarret d'agneau & riz à l'aneth)",
    menuDish2: "Ghormeh Sabzi (ragoût aux herbes et haricots rouges)",
    menuDish3: "Fesenjan (poulet à la grenade et aux noix)",
    menuDish4: "Demandez le spécial du jour à notre équipe",
    menuShawarmaTitle: "Shawarma",
    menuShawarma1: "Assiette shawarma poulet",
    menuShawarma2: "Assiette shawarma bœuf",
    menuShawarma3: "Assiette Shish Taouk",
    menuShawarma4: "Assiette Kafta Kabab",
    menuSandTitle: "Sandwichs & Trios",
    menuSand1: "Sandwich shawarma (poulet ou bœuf)",
    menuSand2: "Sandwich Shish Taouk",
    menuSand3: "Sandwich Kafta",
    menuSand4: "Trio combo (sandwich + frites + boisson)",
    menuSeafoodTitle: "Fruits de Mer",
    menuSeafood1: "Filet de saumon grillé",
  ...
  ar: {
    ...
    highlightText:
      "لحم بقر وضأن مفروم ممزوج بالزعفران والتوابل، مشوي على اللهب المكشوف حتى يصل إلى الكمال المدخن.",
    ...
    aboutCard2Text: "تقنيات شوي فارسية تقليدية لنكهة مدخنة أصيلة.",
    aboutCard3Title: "ضيافة وفعاليات",
    aboutCard3Text: "باقات ضيافة مخصصة للمناسبات الشركاتية والخاصة.",
    menuTitle: "قائمة طعامنا الفارسي والعراقي",
    menuIntro:
      "تشكيلة غنية من الأطباق الفارسية والعراقية المتخصصة. اسأل فريقنا عن خاصية اليوم وعروض الغداء وأطباق العائلة.",
    menuAppTitle: "المقبلات والسلطات",
    menuApp1: "حمص مع خبز بيتا دافئ",
    menuApp2: "ماست-خيار (لبن وخيار)",
    menuApp3: "سلطة فتوش وشيرازي",
    menuApp4: "دولمة (أوراق عنب محشية)",
    menuGrillTitle: "المشويات",
    menuGrill1: "كباب كوبيده (لحم ضأن وبقر مفروم)",
    menuGrill2: "جوجه كباب (دجاج مشوي بالزعفران)",
    menuGrill3: "برج (أسياخ فيليه)",
    menuGrill4: "طبق المشاوي المشكلة",
    menuDishTitle: "أطباق اليوم",
    menuDish1: "باقالي بولو با ماهيتشه (كنافة ضأن وأرز بالشبت)",
    menuDish2: "قورمه سبزي (حساء الأعشاب والفاصولياء الحمراء)",
    menuDish3: "فسنجان (دجاج بالرمان والجوز)",
    menuDish4: "اسأل فريقنا عن خاصية اليوم",
    menuShawarmaTitle: "الشاورما",
    menuShawarma1: "طبق شاورما دجاج",
    menuShawarma2: "طبق شاورما لحم",
    menuShawarma3: "طبق شيش الطاووق",
    menuShawarma4: "طبق كفتة كباب",
    menuSandTitle: "الساندويشات والتريو",
    menuSand1: "ساندويش شاورما (دجاج أو لحم)",
    menuSand2: "ساندويش شيش الطاووق",
    menuSand3: "ساندويش كفتة",
    menuSand4: "تريو كومبو (ساندويش + بطاطس + مشروب)",
    menuSeafoodTitle: "المأكولات البحرية",
    menuSeafood1: "فيليه سلمون مشوي",
    ...
    contactTitle: "التواصل والحجوزات",
    contactText1:
...
function setLanguage(lang) {
  ...
  html.setAttribute("lang", lang === "ar" ? "ar" : lang === "fr" ? "fr" : "en");
  ...
  if (descMeta) {
    descMeta.setAttribute("content", descs[lang] || descs.en);
  }

  const ogLocale = document.querySelector('meta[property="og:locale"]');
  if (ogLocale) {
    const locales = { en: "en_CA", fr: "fr_CA", ar: "ar_CA" };
    ogLocale.setAttribute("content", locales[lang] || "en_CA");
  }
